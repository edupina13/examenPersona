    ...
    <div class="col-12">
      <div class="card mt-5">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12">
              <form class="needs-validation" novalidate action="add-persona?hola=holamundo" method="post"
                ...
                <div class="form-group mb-3">
                  <div class="row">
                    <div class="col-12 text-end">
                      <a class="btn btn-danger btn-sm" href="get-personas">Cancelar</a>
    ...
    Array.prototype.slice.call(forms)
            .forEach(function (form) {
              form.addEventListener('submit', function (event) {
                ...
                let newAction = "add-persona?name="+ name + "&surname=" + surname + "&curp="+ curp +"&birthday=" + birthday;
